...
type Action = {
  ...
  getCollectionComponentList: (collectionId: string, id: string) => CollectionComponentList;
  getComponentValuesBySlug: (collectionId: string, componentSlug: string) => ComponentValueEvent[];
};
